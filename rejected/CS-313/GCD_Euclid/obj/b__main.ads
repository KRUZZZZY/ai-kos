...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#1b95f394#;
   ...
   u00123 : constant Version_32 := 16#45edc460#;
   pragma Export (C, u00123, "gcd_verified_contractsB");
   u00124 : constant Version_32 := 16#17b22dfe#;
   pragma Export (C, u00124, "gcd_verified_contractsS");
   u00125 : constant Version_32 := 16#48433bbe#;
   pragma Export (C, u00125, "system__assertionsB");
   u00126 : constant Version_32 := 16#e2ab43ac#;
   ...
   u00129 : constant Version_32 := 16#b8b74b70#;
   pragma Export (C, u00129, "sparkS");
   u00130 : constant Version_32 := 16#5b4c97f2#;
   pragma Export (C, u00130, "spark__text_ioB");
   u00131 : constant Version_32 := 16#7a20df73#;
   pragma Export (C, u00131, "spark__text_ioS");
   u00132 : constant Version_32 := 16#1716c23c#;
   pragma Export (C, u00132, "spark__text_io__integer_ioB");
   u00133 : constant Version_32 := 16#a85c384e#;
   pragma Export (C, u00133, "spark__text_io__integer_ioS");
   u00134 : constant Version_32 := 16#3720d920#;
   pragma Export (C, u00134, "system__img_biuS");
   u00135 : constant Version_32 := 16#7a7e1efe#;
   pragma Export (C, u00135, "system__img_llbS");
   u00136 : constant Version_32 := 16#15e60e4c#;
   pragma Export (C, u00136, "system__img_lliS");
   u00137 : constant Version_32 := 16#0d8feb8c#;
   pragma Export (C, u00137, "system__img_lllbS");
   u00138 : constant Version_32 := 16#7e360bb4#;
   pragma Export (C, u00138, "system__img_llliS");
   u00139 : constant Version_32 := 16#07fbf280#;
   pragma Export (C, u00139, "system__img_lllwS");
   u00140 : constant Version_32 := 16#264c6bf5#;
   pragma Export (C, u00140, "system__img_llwS");
   u00141 : constant Version_32 := 16#08fa6212#;
   pragma Export (C, u00141, "system__img_wiuS");
   u00142 : constant Version_32 := 16#ae4beccb#;
   pragma Export (C, u00142, "system__val_intS");
   u00143 : constant Version_32 := 16#a5b55d2f#;
   pragma Export (C, u00143, "system__val_unsS");
   u00144 : constant Version_32 := 16#e37e7d10#;
   pragma Export (C, u00144, "system__val_llliS");
   u00145 : constant Version_32 := 16#f82486d6#;
   pragma Export (C, u00145, "system__val_llluS");
   ...
   --  system.assertions%s
   --  system.assertions%b
   --  gcd_verified_contracts%s
   --  gcd_verified_contracts%b
   --  spark%s
   --  spark.text_io%s
   --  spark.text_io%b
